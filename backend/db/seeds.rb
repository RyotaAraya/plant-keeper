...
companies = {
  owner: Company.create!(name: "プラント管理株式会社", company_type: "owner"),
  techno: Company.create!(name: "テクノサービス", company_type: "contractor"),
  plant_maint: Company.create!(name: "プラントメンテナンス", company_type: "contractor"),
  kansai: Company.create!(name: "関西プラントサービス", company_type: "contractor"),
  tohoku: Company.create!(name: "東北計装サービス", company_type: "contractor")
}
...
user_data = [
  # === 川崎製油所 ===
  # 保全部
  { key: :tanaka,     email: "admin@example.com",      name: "田中 太郎",   employment_type: "employee", system_role: "admin",       position: "general_manager", dept: :kw_maint_div, join_year: 2000, pref: "神奈川県" },
  # 計器保全課
  { key: :suzuki,     email: "suzuki@example.com",     name: "鈴木 一郎",   employment_type: "employee", system_role: "supervisor",  position: "section_manager", dept: :kw_inst_sec,  join_year: 2005, pref: "東京都" },
  { key: :sato,       email: "sato@example.com",       name: "佐藤 健太",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :kw_inst_a,    join_year: 2012, pref: "千葉県" },
  { key: :takahashi,  email: "takahashi@example.com",  name: "高橋 美咲",   employment_type: "employee", system_role: "member",      position: "senior_staff",    dept: :kw_inst_a,    join_year: 2015, pref: "埼玉県" },
  { key: :inoue,      email: "inoue@example.com",      name: "井上 真司",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_inst_a,    join_year: 2020, pref: "東京都" },
  { key: :endo,       email: "endo@example.com",       name: "遠藤 大地",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_inst_a,    join_year: 2022, pref: "神奈川県" },
  { key: :fujita,     email: "fujita@example.com",     name: "藤田 翔太",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :kw_inst_b,    join_year: 2013, pref: "静岡県" },
  { key: :nishimura,  email: "nishimura@example.com",  name: "西村 拓也",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_inst_b,    join_year: 2019, pref: "千葉県" },
  { key: :okada,      email: "okada@example.com",      name: "岡田 雅人",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_inst_b,    join_year: 2021, pref: "埼玉県" },
  { key: :yoshida,    email: "yoshida@example.com",    name: "吉田 浩二",   employment_type: "contractor", system_role: "supervisor", position: "staff",           dept: :kw_inst_a,    join_year: 2020, pref: "神奈川県", company_key: :techno },
  { key: :yamada,     email: "yamada@example.com",     name: "山田 修",     employment_type: "contractor", system_role: "worker",     position: "staff",           dept: :kw_inst_b,    join_year: 2021, pref: "東京都", company_key: :plant_maint },
  { key: :honda,      email: "honda@example.com",      name: "本田 慎一",   employment_type: "contractor", system_role: "worker",     position: "staff",           dept: :kw_inst_a,    join_year: 2023, pref: "神奈川県", company_key: :techno },
  # 電気保全課
  { key: :yamamoto,   email: "yamamoto@example.com",   name: "山本 大輔",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :kw_elec_sec,  join_year: 2006, pref: "神奈川県" },
  { key: :watanabe,   email: "watanabe@example.com",   name: "渡辺 直人",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :kw_elec_a,    join_year: 2014, pref: "東京都" },
  { key: :hasegawa,   email: "hasegawa@example.com",   name: "長谷川 誠",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_elec_a,    join_year: 2018, pref: "埼玉県" },
  { key: :aoki,       email: "aoki@example.com",       name: "青木 真理",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_elec_a,    join_year: 2022, pref: "千葉県" },
  # 検査課
  { key: :nakamura,   email: "nakamura@example.com",   name: "中村 雄一",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :kw_insp_sec,  join_year: 2008, pref: "静岡県" },
  { key: :maeda,      email: "maeda@example.com",      name: "前田 裕也",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :kw_insp_a,    join_year: 2014, pref: "神奈川県" },
  { key: :ishida,     email: "ishida@example.com",     name: "石田 康平",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_insp_a,    join_year: 2020, pref: "東京都" },
  # 製造部
  { key: :morimoto,   email: "morimoto@example.com",   name: "森本 隆司",   employment_type: "employee", system_role: "supervisor",  position: "general_manager", dept: :kw_prod_div,  join_year: 2002, pref: "神奈川県" },
  { key: :kato,       email: "kato@example.com",       name: "加藤 誠",     employment_type: "employee", system_role: "member",      position: "section_manager", dept: :kw_oper1_sec, join_year: 2009, pref: "東京都" },
  { key: :shimizu,    email: "shimizu@example.com",    name: "清水 裕太",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :kw_oper1_a,   join_year: 2015, pref: "神奈川県" },
  { key: :ogawa_k,    email: "ogawa_k@example.com",    name: "小川 健一",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_oper1_a,   join_year: 2019, pref: "千葉県" },
  { key: :matsuda,    email: "matsuda@example.com",    name: "松田 和也",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_oper1_b,   join_year: 2020, pref: "東京都" },
  { key: :ueda,       email: "ueda@example.com",       name: "上田 敦",     employment_type: "employee", system_role: "member",      position: "section_manager", dept: :kw_oper2_sec, join_year: 2010, pref: "埼玉県" },
  { key: :nomura,     email: "nomura@example.com",     name: "野村 洋介",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :kw_oper2_a,   join_year: 2016, pref: "神奈川県" },
  { key: :fukuda,     email: "fukuda@example.com",     name: "福田 光太",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_oper2_a,   join_year: 2021, pref: "千葉県" },
  { key: :nagai,      email: "nagai@example.com",      name: "永井 恵子",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :kw_oper2_b,   join_year: 2022, pref: "東京都" },
  # 安全環境部
  { key: :kobayashi,  email: "kobayashi@example.com",  name: "小林 陽子",   employment_type: "employee", system_role: "member",      position: "general_manager", dept: :kw_env_div,   join_year: 2003, pref: "神奈川県" },
  { key: :murakami,   email: "murakami@example.com",   name: "村上 浩",     employment_type: "employee", system_role: "member",      position: "section_manager", dept: :kw_env_sec,   join_year: 2011, pref: "東京都" },
  { key: :saito_k,    email: "saito_k@example.com",    name: "斎藤 健",     employment_type: "employee", system_role: "member",      position: "section_manager", dept: :kw_safety_sec, join_year: 2010, pref: "千葉県" },

  # === 根岸製油所 ===
  { key: :hashimoto,  email: "hashimoto@example.com",  name: "橋本 拓哉",   employment_type: "employee", system_role: "admin",       position: "general_manager", dept: :ng_maint_div, join_year: 2001, pref: "神奈川県" },
  { key: :yamashita,  email: "yamashita@example.com",  name: "山下 聡",     employment_type: "employee", system_role: "supervisor",  position: "section_manager", dept: :ng_inst_sec,  join_year: 2007, pref: "東京都" },
  { key: :imai,       email: "imai@example.com",       name: "今井 大介",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :ng_inst_a,    join_year: 2014, pref: "神奈川県" },
  { key: :ogata,      email: "ogata@example.com",      name: "緒方 慎太郎", employment_type: "employee", system_role: "member",      position: "staff",           dept: :ng_inst_a,    join_year: 2019, pref: "千葉県" },
  { key: :kaneko,     email: "kaneko@example.com",     name: "金子 亮",     employment_type: "employee", system_role: "member",      position: "staff",           dept: :ng_inst_a,    join_year: 2021, pref: "埼玉県" },
  { key: :ota,        email: "ota@example.com",        name: "太田 智子",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :ng_elec_sec,  join_year: 2009, pref: "神奈川県" },
  { key: :goto,       email: "goto@example.com",       name: "後藤 幸一",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :ng_elec_a,    join_year: 2015, pref: "東京都" },
  { key: :miura,      email: "miura@example.com",      name: "三浦 翔",     employment_type: "employee", system_role: "member",      position: "staff",           dept: :ng_elec_a,    join_year: 2020, pref: "千葉県" },
  { key: :kuroda,     email: "kuroda@example.com",     name: "黒田 将人",   employment_type: "employee", system_role: "supervisor",  position: "general_manager", dept: :ng_prod_div,  join_year: 2004, pref: "神奈川県" },
  { key: :noguchi,    email: "noguchi@example.com",    name: "野口 裕介",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :ng_oper1_sec, join_year: 2011, pref: "東京都" },
  { key: :harada,     email: "harada@example.com",     name: "原田 美紀",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :ng_oper1_a,   join_year: 2016, pref: "神奈川県" },
  { key: :kawano,     email: "kawano@example.com",     name: "川野 達也",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :ng_oper1_a,   join_year: 2021, pref: "千葉県" },
  { key: :takeda,     email: "takeda@example.com",     name: "武田 誠一",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :ng_oper1_b,   join_year: 2022, pref: "埼玉県" },
  { key: :hirata,     email: "hirata@example.com",     name: "平田 恵",     employment_type: "employee", system_role: "member",      position: "section_manager", dept: :ng_env_sec,   join_year: 2012, pref: "神奈川県" },

  # === 堺製油所 ===
  { key: :ito,        email: "ito@example.com",        name: "伊藤 和也",   employment_type: "employee", system_role: "admin",       position: "general_manager", dept: :sk_maint_div, join_year: 2002, pref: "大阪府" },
  { key: :kimura,     email: "kimura@example.com",     name: "木村 拓哉",   employment_type: "employee", system_role: "supervisor",  position: "section_manager", dept: :sk_inst_sec,  join_year: 2008, pref: "兵庫県" },
  { key: :tanabe,     email: "tanabe@example.com",     name: "田辺 雄太",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :sk_inst_a,    join_year: 2014, pref: "大阪府" },
  { key: :nishida,    email: "nishida@example.com",    name: "西田 真一",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sk_inst_a,    join_year: 2019, pref: "京都府" },
  { key: :kawaguchi,  email: "kawaguchi@example.com",  name: "川口 啓介",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sk_inst_a,    join_year: 2022, pref: "兵庫県" },
  { key: :hayashi,    email: "hayashi@example.com",    name: "林 真理子",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :sk_inst_b,    join_year: 2015, pref: "大阪府" },
  { key: :fujimoto,   email: "fujimoto@example.com",   name: "藤本 健二",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sk_inst_b,    join_year: 2020, pref: "奈良県" },
  { key: :otsuka,     email: "otsuka@example.com",     name: "大塚 恵美",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :sk_elec_sec,  join_year: 2009, pref: "大阪府" },
  { key: :sugiyama,   email: "sugiyama@example.com",   name: "杉山 浩二",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :sk_elec_a,    join_year: 2016, pref: "兵庫県" },
  { key: :moriyama,   email: "moriyama@example.com",   name: "森山 裕一",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sk_elec_a,    join_year: 2021, pref: "大阪府" },
  { key: :iwamoto,    email: "iwamoto@example.com",    name: "岩本 亮介",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :sk_insp_sec,  join_year: 2010, pref: "大阪府" },
  { key: :wada,       email: "wada@example.com",       name: "和田 美穂",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :sk_insp_a,    join_year: 2017, pref: "兵庫県" },
  { key: :sk_prod_mgr, email: "nakata@example.com",    name: "中田 慎吾",   employment_type: "employee", system_role: "supervisor",  position: "general_manager", dept: :sk_prod_div,  join_year: 2003, pref: "大阪府" },
  { key: :ogawa,      email: "ogawa@example.com",      name: "小川 美穂",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :sk_oper1_sec, join_year: 2011, pref: "大阪府" },
  { key: :kitamura,   email: "kitamura@example.com",   name: "北村 剛志",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :sk_oper1_a,   join_year: 2017, pref: "兵庫県" },
  { key: :murata,     email: "murata@example.com",     name: "村田 裕子",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sk_oper1_a,   join_year: 2021, pref: "大阪府" },
  { key: :arai,       email: "arai@example.com",       name: "荒井 康太",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sk_oper1_b,   join_year: 2023, pref: "京都府" },
  { key: :sk_contractor1, email: "kubo@example.com",   name: "久保 正人",   employment_type: "contractor", system_role: "worker",     position: "staff",           dept: :sk_inst_a,    join_year: 2021, pref: "大阪府", company_key: :kansai },

  # === 和歌山製油所 ===
  { key: :wk_mgr,     email: "abe@example.com",        name: "阿部 俊介",   employment_type: "employee", system_role: "admin",       position: "general_manager", dept: :wk_maint_div, join_year: 2003, pref: "和歌山県" },
  { key: :wk_inst_mgr, email: "kawamoto@example.com",  name: "川本 浩一",   employment_type: "employee", system_role: "supervisor",  position: "section_manager", dept: :wk_inst_sec,  join_year: 2009, pref: "和歌山県" },
  { key: :wk_inst1,   email: "doi@example.com",        name: "土井 拓真",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :wk_inst_a,    join_year: 2015, pref: "大阪府" },
  { key: :wk_inst2,   email: "hara@example.com",       name: "原 雅之",     employment_type: "employee", system_role: "member",      position: "staff",           dept: :wk_inst_a,    join_year: 2020, pref: "和歌山県" },
  { key: :wk_inst3,   email: "taguchi@example.com",    name: "田口 和美",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :wk_inst_a,    join_year: 2023, pref: "奈良県" },
  { key: :wk_elec_mgr, email: "morita_w@example.com",  name: "森田 達也",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :wk_elec_sec,  join_year: 2010, pref: "和歌山県" },
  { key: :wk_elec1,   email: "komori@example.com",     name: "小森 秀樹",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :wk_elec_a,    join_year: 2016, pref: "大阪府" },
  { key: :wk_oper_mgr, email: "hirose@example.com",    name: "広瀬 義男",   employment_type: "employee", system_role: "supervisor",  position: "general_manager", dept: :wk_prod_div,  join_year: 2004, pref: "和歌山県" },
  { key: :wk_oper1,   email: "sakai@example.com",      name: "酒井 勝",     employment_type: "employee", system_role: "member",      position: "section_manager", dept: :wk_oper1_sec, join_year: 2012, pref: "和歌山県" },
  { key: :wk_oper2,   email: "kurata@example.com",     name: "倉田 隆志",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :wk_oper1_a,   join_year: 2017, pref: "大阪府" },
  { key: :wk_oper3,   email: "matsubara@example.com",  name: "松原 薫",     employment_type: "employee", system_role: "member",      position: "staff",           dept: :wk_oper1_a,   join_year: 2022, pref: "和歌山県" },
  { key: :wk_oper4,   email: "yasuda@example.com",     name: "安田 光一",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :wk_oper1_b,   join_year: 2023, pref: "兵庫県" },

  # === 仙台製油所 ===
  { key: :sasaki,     email: "sasaki@example.com",     name: "佐々木 隆",   employment_type: "employee", system_role: "admin",       position: "general_manager", dept: :sd_maint_div, join_year: 2004, pref: "宮城県" },
  { key: :matsumoto,  email: "matsumoto@example.com",  name: "松本 剛",     employment_type: "employee", system_role: "supervisor",  position: "section_manager", dept: :sd_inst_sec,  join_year: 2010, pref: "岩手県" },
  { key: :sd_inst1,   email: "chiba_t@example.com",    name: "千葉 拓斗",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :sd_inst_a,    join_year: 2015, pref: "宮城県" },
  { key: :sd_inst2,   email: "oikawa@example.com",     name: "及川 大輝",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sd_inst_a,    join_year: 2020, pref: "秋田県" },
  { key: :sd_inst3,   email: "sugawara@example.com",   name: "菅原 涼太",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sd_inst_a,    join_year: 2023, pref: "宮城県" },
  { key: :sd_elec_mgr, email: "takagi@example.com",    name: "高木 勇人",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :sd_elec_sec,  join_year: 2011, pref: "福島県" },
  { key: :sd_elec1,   email: "kumagai@example.com",    name: "熊谷 正樹",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :sd_elec_a,    join_year: 2016, pref: "宮城県" },
  { key: :sd_elec2,   email: "shibata@example.com",    name: "柴田 恵子",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sd_elec_a,    join_year: 2021, pref: "山形県" },
  { key: :sd_prod_mgr, email: "endo_sd@example.com",   name: "遠藤 孝明",   employment_type: "employee", system_role: "supervisor",  position: "general_manager", dept: :sd_prod_div,  join_year: 2005, pref: "宮城県" },
  { key: :sd_oper1,   email: "konno@example.com",      name: "今野 真吾",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :sd_oper1_sec, join_year: 2012, pref: "宮城県" },
  { key: :sd_oper2,   email: "abe_sd@example.com",     name: "阿部 慶太",   employment_type: "employee", system_role: "member",      position: "team_leader",     dept: :sd_oper1_a,   join_year: 2018, pref: "岩手県" },
  { key: :sd_oper3,   email: "sato_sd@example.com",    name: "佐藤 彩花",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :sd_oper1_a,   join_year: 2022, pref: "宮城県" },
  { key: :sd_contractor1, email: "mikami@example.com",  name: "三上 賢治",   employment_type: "contractor", system_role: "worker",     position: "staff",           dept: :sd_inst_a,    join_year: 2022, pref: "宮城県", company_key: :tohoku },

  # === 千葉（閉鎖）→ 退職者 ===
  { key: :morita,     email: "morita@example.com",     name: "森田 正義",   employment_type: "employee", system_role: "member",      position: "section_manager", dept: :cb_inst_sec,  join_year: 2006, pref: "千葉県", inactive: true },
  { key: :cb_worker1, email: "oishi@example.com",      name: "大石 裕次",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :cb_inst_sec,  join_year: 2015, pref: "千葉県", inactive: true },
  { key: :cb_oper1,   email: "suzuki_c@example.com",   name: "鈴木 将大",   employment_type: "employee", system_role: "member",      position: "staff",           dept: :cb_oper1_sec, join_year: 2016, pref: "千葉県", inactive: true }
]
...
user_data.each do |data|
  u = User.create!(
    ...
    company: companies[data[:company_key] || :owner],
